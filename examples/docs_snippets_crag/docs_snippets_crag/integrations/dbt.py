...
def scope_dbt_cli_run():
    ...
    my_dbt_job = my_dbt_graph.to_job(resource_defs={"dbt": my_dbt_resource})
...
def scope_dbt_cli_profile_modes():
    ...
    my_dbt_graph_dev = my_dbt_graph.to_job(
        resource_defs={
    ...
    my_dbt_graph_prod = my_dbt_graph.to_job(
        resource_defs={
            "dbt": dbt_cli_resource.configured(
...
def scope_dbt_rpc_run():
    ...
    my_dbt_job = my_dbt_graph.to_job(resource_defs={"dbt_rpc": my_remote_rpc})
...
def scope_dbt_cli_config_profile_and_target():
    ...
    my_job = my_graph.to_job(resource_defs={"dbt": dbt_cli_resource.configured(config)})
